...
void fslCalculateNormals(float *triangleArray, int size, float *normalArray)
{
    ...
    for(i=0; i < size_div_3; i++){

        float v1[3]={0.0f};
        float v2[3]={0.0f};
        float v3[3]={0.0f};
        /* float v4[3]={0.0f};  no use so pp delete it */

        float A[3]={0.0f};
        float B[3]={0.0f};
        /* float C[3]={0.0f};  no use so pp delete it */
        /* float D[3]={0.0f};  no use so pp delete it */
        float result[3]={0.0f};
